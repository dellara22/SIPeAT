    ...
    <div class=" pt-24 pb-24 h-full w-full flex justify-center items-center">
        <div class=" bg-transparent w-1/2 ">
            <div class="flex justify-center  ">
                <h1 class="text-white font-bold text-xl bg-[#192257] w-5/6 text-center py-2 rounded-sm">Form Peminjaman</h1>
            </div>
            <div class="bg-white text-white mt-3 p-4 rounded-lg">
                <form enctype="multipart/form-data" id="myForm" class="flex flex-col gap-3"
                    action="{{ route('store-peminjaman') }}" method="POST">
                    @csrf
                    @method('POST')
                    {{-- Ruangan --}}
                    <div>
                        ...
                        <select id="ruangan" name="ruangan"
                            ...
                            @foreach ($ruangans as $ruang)
                                @if ($ruang->id == $room)
                                    <option selected value="{{ $ruang->id }}">{{ $ruang->name }}</option>
                                @else
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input datepicker type="text" name="tanggal"
                                ...
                                placeholder="Select date" value="{{ $tanggal }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="kegiatan" name="kegiatan"
                            ...
                            placeholder="Masukkan Nama Kegiatan/acara" required />
                    </div>
                    {{-- Nama Ketua Acara --}}
                    <div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4"
                            ...
                            placeholder="Masukkan Deskripsi Kegiatan/Acara..."></textarea>
                    </div>
                    {{-- Upload Surat Permohonan --}}
                    <div>

                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="surat">UPLOAD
